          ...
          <div class="flex items-center space-x-2 xl:space-x-3">
              ...
              <RouterLink to="/cart" class="relative group">
                <div
                  ...
                  <span v-if="cart.length"
                    class="bg-red-500 text-white rounded-full px-2 py-0.5 text-xs font-bold shadow-lg">
            ...
            <div v-else class="relative group">
              ...
              <div
                ...
                <RouterLink to="/cart" class="block px-3 py-2 text-sm hover:bg-gray-100 rounded-t-lg transition">
                  Sepetim
                  <span v-if="cart.length" class="ml-2 bg-red-500 text-white rounded-full px-2 py-0.5 text-xs">
                    {{cart.reduce((acc, i) => acc + i.quantity, 0)}}
                  </span>
                </RouterLink>

                <RouterLink to="/customer-panel" class="block px-3 py-2 text-sm hover:bg-gray-100 transition">
                  Kullanıcı Paneli
                </RouterLink>
      ...
      <ul class="space-y-2 pt-2">
        ...
        <li>
          <RouterLink to="/cart" @click="isMobileMenuOpen = false" class="block">
            <div
              class="flex items-center justify-between gap-3 px-4 py-3 rounded-lg bg-blue-700 hover:bg-blue-600 transition-all duration-300 shadow-md">
        ...
        <li v-else class="space-y-2 pt-2">
          <!-- Kullanıcı Bilgisi -->
          <div class="flex items-center gap-5 px-4 py-3.5 rounded-lg shadow-md">
          ...
          <RouterLink v-if="user.role === 'admin'" to="/admin" @click="isMobileMenuOpen = false">
            <div
              class="flex items-center justify-center gap-2 px-4 py-3 mt-3 rounded-lg bg-purple-600 hover:bg-purple-500 transition-all duration-300 shadow-md">
          ...
          <button @click="logout" class="w-full">
            <div
              class="flex items-center justify-center gap-2 px-4 py-3 mt-3 rounded-lg bg-red-600 hover:bg-red-500 transition-all duration-300 shadow-md">
