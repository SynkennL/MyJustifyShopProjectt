        ...
        <div class="hidden lg:flex items-center space-x-4 xl:space-x-6">
          ...
          <div class="flex items-center space-x-2 xl:space-x-3">
            ...
            <RouterLink to="/cart" class="relative group">
              <div
                class="flex items-center gap-1.5 px-3 py-1.5 xl:px-4 xl:py-2 rounded-lg bg-blue-700 hover:bg-green-500 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105">
                ...
                <span v-if="cart.length"
                  class="absolute -top-1.5 -right-1.5 bg-red-500 text-white rounded-full w-5 h-5 text-xs font-bold flex items-center justify-center animate-pulse shadow-lg border-2 border-white">
            ...
            <div v-else class="flex items-center gap-2">
              ...
              <RouterLink to="/customer-panel">
                <div
                  ...
                  <svg v-if="user.role === 'admin'" class="w-4 h-4 xl:w-5 xl:h-5" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  <svg v-else class="w-4 h-4 xl:w-5 xl:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  <span class="font-bold text-xs xl:text-sm hidden lg:inline">{{ user.role === 'admin' ? 'Yönetici Panel' :
                    'Panelim' }}</span>
                </div>
              </RouterLink>
