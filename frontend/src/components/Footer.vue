  ...
  <footer class="bg-gray-900 text-gray-200 pt-12 pb-6 mt-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- Logo & Hakkımızda -->
        <div>
          <h2 class="text-xl font-bold mb-4">JustifyShop</h2>
          <p class="text-gray-400 text-sm">
            En trend ürünler, güvenli alışveriş ve hızlı teslimat ile sizlere en iyi deneyimi sunuyoruz.
          </p>
        </div>
        ...
        <div>
          ...
          <form class="flex flex-col space-y-2">
            <input type="email" placeholder="E-posta adresiniz" required
              class="rounded-full border border-gray-400 shadow-md font-semibold px-3 p-3 rounded text-white" />
            <button type="submit"
              class="hover:bg-blue-600 mt-5 text-white font-bold py-2 px-4 rounded-full border border-blue-500 shadow-md transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">Abone
              Ol</button>
          </form>

          <!-- Sosyal Medya İkonları -->
          <div class="mt-6 flex space-x-4">
            <a href="https://www.facebook.com" class="duration-500 hover:-translate-y-2">
            ...
            <a href="https://www.instagram.com" class="duration-500 hover:-translate-y-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
            ...
            <a href="https://www.twitter.com" class="duration-500 hover:-translate-y-2">
      ...
      <div class="italic border-t border-gray-700 mt-5 pt-2 text-center text-gray-500 text-sm">
