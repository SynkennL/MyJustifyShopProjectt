        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <label :class="[
              ...
              role === 'customer' ? 'border-blue-500 bg-blue-50 shadow-md' : 'border-gray-200 bg-gray-50 hover:border-gray-300'
            ]">
              <input type="radio" v-model="role" value="customer" class="sr-only" />
              <svg class="w-12 h-12 mx-auto mb-3" :class="role === 'customer' ? 'text-blue-500' : 'text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <svg v-if="role === 'customer'" class="w-6 h-6 text-blue-500 absolute top-3 right-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <label :class="[
              'relative flex flex-col items-center justify-center p-6 border-2 rounded-xl cursor-pointer transition-all',
              role === 'admin' ? 'border-purple-500 bg-purple-50 shadow-md' : 'border-gray-200 bg-gray-50 hover:border-gray-300'
            ]">
              <input type="radio" v-model="role" value="admin" class="sr-only" />
              <svg class="w-12 h-12 mx-auto mb-3" :class="role === 'admin' ? 'text-purple-500' : 'text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <svg v-if="role === 'admin'" class="w-6 h-6 text-purple-500 absolute top-3 right-3" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
              </svg>
            </label>
          </div>
